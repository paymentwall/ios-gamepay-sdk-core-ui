...
public class EmailRule: RegexRule {
     ...
     */
    public convenience init(message : String = "Please enter a valid email address"){
        if message.elementsEqual("Please enter a valid email address") {
            self.init(regex: EmailRule.regex, message: "Please enter a valid email address")
        }
        else {
